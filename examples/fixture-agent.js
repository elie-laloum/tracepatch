...
console.log(JSON.stringify({ summary: 'Multiply unit price by quantity.', edits: [{ path: file.path, content: file.content.replace('return price;', 'return price * quantity;') }] }));
